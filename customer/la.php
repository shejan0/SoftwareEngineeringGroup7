...
<div class="container-fluid bg-white">
  <div class="row">
    <div class="col-lg-6 py-4 p-xl-5">
      <h2 class="mb-4">Los Angeles, CA</h2>
      <hr class="my-4">
        ...
        <div class="col-sm-6 mb-5 hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92">
          <div class="card h-100  shadow-soft border-light animate-up-2 bg-white">
            <div class="card-img-top overflow-hidden gradient-overlay">
              <img class="img-fluid" src="../assets/img/hotels/hotel-room1.jpeg" alt="Modern, Well-Appointed Room" />
...
<script>
  createListingsMap({
    ...
    jsonFile: '../assets/js/cities-map/los-angeles.json',
    mapPopupType: 'rental',
    useTextIcon: true,
