            ...
            <div class="container">
                <div class="row mb-2 mb-lg-2">
                    <div class="col-12 col-md-9 col-lg-8 text-center mx-auto">
                        <h2 class="h1 mb-4">Book your next destination from the best hotels in your city.</h2>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <img class="navbar-brand-dark mb-4" height="35" src="../assets/img/brand/light.svg"
                        alt="Logo light">
                    <p>Created using pixel. Pixel a free and open source Bootstrap 5 UI Kit that will help you prototype
                        and build
                        beautiful website pages and applications.</p>
                    <ul class="social-buttons mb-5 mb-lg-0">
                        <button class="btn btn-icon-only btn-facebook animate-up-3 rounded-pill" type="button"
                        ...
                        <button class="btn btn-icon-only btn-instagram animate-up-3 rounded-pill" type="button"
                            aria-label="youtube button" title="youtube button">
                            <span aria-hidden="true" class="fab fa-instagram"></span>
                        </button>
                        <button class="btn btn-icon-only btn-github animate-up-3 rounded-pill" type="button"
                            aria-label="behance button" title="behance button">
                    ...
                    <form action="#">
                        <div class="form-row mb-2">
                            ...
                            <div class="col-12 d-grid">
                                <button type="submit" class="btn btn-tertiary animate-up-4" data-loading-text="Sending">
                                    <span>Subscribe</span>
                                </button>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col mb-md-0">
                    <a href="#" # class="d-flex justify-content-center mb-3">
                        <img src="../assets/img/brand/light.svg" height="30" class="me-2" alt="Themesberg Logo">
