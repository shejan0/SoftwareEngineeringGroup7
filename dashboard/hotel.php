...
<main class="content bg-white">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
                    ...
                    <button type="button" class="btn btn-sm bg-white shadow-soft border-light align-items-center animate-up-2" data-bs-toggle="modal" data-bs-target="#addHotel">
                <span class='fas fa-hotel'></span>
                Add hotel
            </button>
             <!-- Modal Content -->
             <div class="modal fade" id="addHotel" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body px-md-5">
                            <h2 class="h4 text-center">Enter Hotel information</h2>
                            <form action="server.php" method=POST>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Name" class="form-control border-gray-300" id="hotel_name" name="hotel_name" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-gray-300" placeholder="Total rooms" id="total_rooms" name='total_rooms' autofocus required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Price of standard rooms" class="form-control border-gray-300" id="standard" name='standard' required>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Price of queen rooms" class="form-control border-gray-300" id="queen" name='queen' required>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Price of king rooms" class="form-control border-gray-300" id="king" name='king' required>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="Percentage upcharge for the weekends" class="form-control border-gray-300" id="weekend_surge" name='weekend_surge' required>
                                        </div>
                                    </div>
                                </div>
                                <!-- submit -->
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary" name='add_hotels'>Submit</button>
                                </div>
                            </form>
                            </div>
                        </div>
                        ...
                        <a type="button" class="btn bg-white shadow-soft border-light animate-up-2" href='modifyProperty.php'>Edit Properties</a>
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body px-md-5">
                            ...
                            <div class="d-flex justify-content-center my-2">
                                <a href="https://www.facebook.com/" class="btn btn-icon-only btn-pill btn-outline-gray-500 me-2" aria-label="facebook button" title="facebook button">
                                ...
                                <a href="https://twitter.com/" class="btn btn-icon-only btn-pill btn-outline-gray-500 me-2" aria-label="twitter button" title="twitter button">
                                ...
                                <a href="https://github.com/" class="btn btn-icon-only btn-pill btn-outline-gray-500" aria-label="github button" title="github button">
