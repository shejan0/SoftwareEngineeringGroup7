            ...
            <div class="container">
                <div class="row align-items-center ">
                    <div class="col-12 col-lg-5 order-2 order-lg-1 text-center text-lg-left">
                        <h1 class="mt-5">Error! Incorrect email or <span class="text-primary">password</span></h1>
                        <p class="lead my-4">The email or password you entered did not match our records.
                            Please double check and try again.</p>
                        <a href="sign-in.html" class="btn btn-gray-800 d-inline-flex align-items-center justify-content-center mb-4">
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                            <span class="fw-normal">
                                Not registered?
                                <a href="sign-up.html" class="fw-bold text-underline">Sign up here</a>
                            </span>
                        </div>
                    </div>
                    <div class="col-12 col-lg-7 order-1 order-lg-2 text-center d-flex align-items-center justify-content-center">
                        <img class="img-fluid w-75" src="../assets/img/error/500.svg" alt="500 Server Error">
                    </div>
                </div>
            </div>
        </section>
